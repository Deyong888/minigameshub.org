...
const SITE = {"name":"MiniGamesHub","site":"https://minigameshub.org","base":"/","trailingSlash":false,"googleSiteVerificationId":"orcPxI47GSa-cRvY11tUe6iGg2IO_RPvnA1q95iEM3M"};
                    const I18N = {"language":"en","textDirection":"ltr"};
                    const METADATA = {"title":{"default":"MiniGamesHub — Play 3,900+ Free Online Games Instantly","template":"%s — MiniGamesHub"},"description":"Discover and play 3,900+ free online mini games, arcade games, puzzle games, and more on MiniGamesHub.org. Instant browser play, no download required! Perfect for work breaks, school free time, or anytime you're bored.","openGraph":{"type":"website","site_name":"MiniGamesHub","images":[{"url":"~/assets/images/default.png","width":1200,"height":628,"alt":"MiniGamesHub — Free Online Games"}],"locale":"en_US"},"twitter":{"handle":"@MiniGamesHub","site":"@MiniGamesHub","cardType":"summary_large_image"}};
                    ...
                    const ANALYTICS = {"vendors":{"googleAnalytics":{"id":"G-P13CNRCFEP","partytown":true}}};
...
export { ANALYTICS as A, BLOG_BASE as B, CATEGORY_BASE as C, I18N as I, METADATA as M, POST_PERMALINK_PATTERN as P, SITE as S, TAG_BASE as T, UI as U, getPermalink as a, getFormattedDate as b, getBlogPermalink as c, getCanonical as d, getAsset as e, cleanSlug as f, getHomePermalink as g, APP_BLOG as h, trimSlash as t };
