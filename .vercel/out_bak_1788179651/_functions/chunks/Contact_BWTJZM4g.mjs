import { d as createAstro, c as createComponent, m as maybeRenderHead, b as addAttribute, a as renderTemplate, r as renderComponent } from './astro/server_BWaOESUl.mjs';
import 'piccolore';
import { a as $$Button } from './PageLayout_BTCUs-UC.mjs';
import { $ as $$Headline } from './Headline_CdgpVOLs.mjs';
...
const $$Form = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Form;
  const { inputs, textarea, disclaimer, button = "Contact us", description = "", action } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<form method="POST"${addAttribute(action || "https://formspree.io/f/moqrjykz", "action")}> ${inputs && inputs.map(
...
}, "E:/website/minigameshub.org/src/components/ui/Form.astro", void 0);
